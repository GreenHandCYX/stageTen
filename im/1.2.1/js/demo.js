...
.controller('demoCtrl', ['$scope', function($scope) {
  ...
  $scope.across_name = 'xiezefan666';
  $scope.appkey = '4f7aef34fb361292c566a1cd';
  $scope.member_list = [{
    'username': 'xuqijin2',
    'appkey': '4f7aef34fb361292c566a1cd'
  }, {
    'username': 'JSCrossTest1',
    'appkey': '25b693b31d2c2ad5f072ef0c'
  }]
  ...
  $scope.register = function() {
    ...
    JIM.register($scope.regname, $scope.regpwd, $scope.auth_platform, function(data){
      console.log(data)
  ...
  $scope.login = function() {
    ...
    JIM.login($scope.username, $scope.password, $scope.auth_platform, function(data){
      console.log(data)
  ...
  $scope.getUserInfo = function() {
    ...
    JIM.getUserInfo($scope.friend_name, function(data){
      console.log(data)
    }, $scope.ack, $scope.timeout);
  }
  ...
  $scope.getAcrossUserInfo = function() {
    ...
    JIM.getAcrossUserInfo($scope.across_name, $scope.appkey, function(data){
      console.log(data)
    }, $scope.ack, $scope.timeout);
  }
  ...
  $scope.sendSingleMsg = function() {
    ...
    JIM.sendSingleMsg($scope.friend_name, $scope.val, $scope.resp, $scope.ack, $scope.timeout);
  ...
  $scope.sendGroupMsg = function() {
    ...
    JIM.sendGroupMsg($scope.group_id, $scope.val, $scope.resp, $scope.ack, $scope.timeout);
  }
  ...
  document.getElementById('upSingleImg').addEventListener('click', function() {
    ...
    JIM.uploadImg({
      target_username: $scope.friend_name,
      appkey: $scope.appkey,
      fd: fd,
      resp: $scope.resp,
      ack: $scope.ack,
